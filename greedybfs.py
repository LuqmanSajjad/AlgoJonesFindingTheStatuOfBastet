...
class Cell:
    ...
    # return path to nearest deadend chamber !!!
    def bfs_toDeadend(self, deadends):
        ...
        while len(frontier) > 0:
            ...
            # retrieving all the current chambers neighbouring chambers
            for d in 'WSNE':
...
def change_position(cell, next_cell, deadends):
    # print("going ", next_cell.x, next_cell.y)
    # t = input()
    ...
    # changing the decission to update the neighbours before moving to next cell
